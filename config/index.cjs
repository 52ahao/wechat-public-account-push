  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '生日', name: '宝宝', year: '2005', date: '02-19',
        },
        {
          type: '节日', name: '恋爱纪念日', year: '2023', date: '09-06',
        },
      ...
      courseSchedule: {
        ...
        courses: {
          ...
          odd: [
            // 例子，周一的课表
            [
              '第一大节 英语@教学2号楼216 1-16(周)',
              '第二大节 逻辑学@教学2号楼313 1-16(周)',
              '第三大节 形势与政策@教学2号楼208 12-13(周)',
              '第五大节 文学作品选读@教学2号楼308 1-16(周)'
            ],
            // 周二
            [
              '第一大节 公共关系@教学2号楼208 1-16(周)',
              '第三大节 普通话@教学2号楼614 1-16(周)',
              '第四大节 职业生涯@教学3号楼201 10-13(周)',
              '第五大节 0ffice@实验室1-301 1-16(周)'
            ],
            // 周三
            [
              '第一大节 秘书学概@教学2号楼215 1-16(周)',
              '第三大节 英语@教学3号楼409 1-16(单周)'
              
              
            ],
            // 周四
            [
              '第一大节 Office @实验室1-301 1-16(单周)',
              '第二大节 秘书学@教学2号楼215 1-16(周)',
              '第三大节 心理健康@教学3号楼201 15-18(周)',
              '第四大节 文学作品@教学2号楼305 1-16(周)'
            ],
            // 周五
            [
              '第一大节 近现代史@教学2号楼114 1-16(周)',
              '第三大节 体育 1-18(周)',
              '第四大节 安全用药知@教学3号楼308 3-12(周)'
